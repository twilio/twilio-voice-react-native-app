...
describe('Outgoing Call', () => {
  ...
  it('should allow user to enter PTSN number 2', async () => {
    await element(by.id('dialpad_button_3')).tap();
    await waitFor(element(by.id('dialpad_button_1')))
      .toBeVisible()
      .withTimeout(2000);
    await element(by.id('dialpad_button_1')).tap();
    await waitFor(element(by.id('dialpad_button_5')))
      .toBeVisible()
      .withTimeout(2000);
    await element(by.id('dialpad_button_5')).tap();
    await waitFor(element(by.id('dialpad_button_6')))
      .toBeVisible()
      .withTimeout(2000);
    await element(by.id('dialpad_button_6')).tap();
    await waitFor(element(by.id('dialpad_button_7')))
      .toBeVisible()
      .withTimeout(2000);
    await element(by.id('dialpad_button_7')).tap();
    await waitFor(element(by.id('dialpad_button_0')))
      .toBeVisible()
      .withTimeout(2000);
    await element(by.id('dialpad_button_0')).tap();
    await waitFor(element(by.id('dialpad_button_3')))
      .toBeVisible()
      .withTimeout(2000);
    await element(by.id('dialpad_button_3')).tap();
    await waitFor(element(by.id('dialpad_button_5')))
      ...
      .withTimeout(2000);
    await element(by.id('dialpad_button_5')).tap();
    await waitFor(element(by.id('dialpad_button_4')))
      .toBeVisible()
      .withTimeout(2000);
    await element(by.id('dialpad_button_4')).tap();
    await waitFor(element(by.id('dialpad_button_1')))
  ...
  it('should allow user enter PTSN (timeout)', async () => {
    await element(by.id('dialpad_button_3')).tap();
    await createTimerPromise(1000, 'settle button press');
    await element(by.id('dialpad_button_1')).tap();
    await createTimerPromise(1000, 'settle button press');
    await element(by.id('dialpad_button_5')).tap();
    await createTimerPromise(1000, 'settle button press');
  ...
  it('should allow user to enter PTSN (different number)', async () => {
    await element(by.id('dialpad_button_8')).tap();
    await element(by.id('dialpad_button_1')).tap();
    await element(by.id('dialpad_button_4')).tap();
    await element(by.id('dialpad_button_9')).tap();
    await element(by.id('dialpad_button_8')).tap();
    await element(by.id('dialpad_button_5')).tap();
    await element(by.id('dialpad_button_0')).tap();
    await element(by.id('dialpad_button_7')).tap();
    await element(by.id('dialpad_button_9')).tap();
    await element(by.id('dialpad_button_1')).tap();
    await expect(element(by.id('formatted_number'))).toHaveText('+8149850791');
  });
